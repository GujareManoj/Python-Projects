...
#label
music = Label(root,text="",font=("times new roman",10),fg="white",bg="#0f1a2b")
...
Button(root,text="Open Folder",width=15,height=2,font=("times new roman",10,"bold"),fg="grey", bg="#21b3de",command=open_folder).place(x=330,y=300)

scroll = Scrollbar(music_frame)
playlist = Listbox(music_frame,width=100,font=("times new roman",10),fg="grey",bg="#333333",selectbackground="lightblue",cursor="hand2",bd=0,yscrollcommand=scroll.set)
